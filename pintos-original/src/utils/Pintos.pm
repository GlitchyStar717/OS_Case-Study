...
sub read_loader {
    my ($name) = @_;
    #$name = find_file ("loader.bin") if !defined $name; #Edited Here
    $name = find_file ("/home/hooman/Desktop/OS/pintOS/pintos-anon-master/src/threads/build/loader.bin") if !defined $name;
